...
public class FindHesse {
    ...
    public static void main(String[] args) {
       ...
       // getOccurences(textToAnalyse);
        printWordInUppercase(textToAnalyse, sc);



    }

    public static void getOccurences(String text) {
        int counter = 0;
        int index = text.indexOf("Hesse");

        while (index >= 0) {
            System.out.println("Hesse Nr." + counter + " has Index: " + index);
            counter++;
            index = text.indexOf("Hesse", 1+ index);
        }
        System.out.println();
        System.out.println("Number of \"Hesse\" occurences: " + counter);
    }

    public static void printWordInUppercase(String text, Scanner sc) {
        System.out.println("Enter word to print in uppercase:");
