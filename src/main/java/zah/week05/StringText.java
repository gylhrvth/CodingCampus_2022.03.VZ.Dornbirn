...
private static String testString1 = "              ";
    ...
    public static void main(String[] args) {
        ...
        System.out.println(testString.substring(position));

        System.out.println(testString.toLowerCase());
        System.out.println(testString.toUpperCase());

        // Format Funktion
        System.out.println(String.format("*%d* *%10d* *%-5d*", 10, 10, 10));
        ...
        System.out.println(String.format("*%1$s* *%1$10.2s* *%1$-10s*", "Apfel"));
