...
public class SearchingForHesseV1 {
    ...
    public static void main(String[] args) {
        ...
        // Split the text
        String[] arrOfText = textToAnalyse.split(" ");

        // Check if they are equal to "Hesse"
        for (int i = 0; i < arrOfText.length; i++) {

            if (arrOfText[i].equalsIgnoreCase("Hesse")) {
                counter++;
            }
        }
        System.out.println("There are " +counter +  " times Hesse");
    }
}
