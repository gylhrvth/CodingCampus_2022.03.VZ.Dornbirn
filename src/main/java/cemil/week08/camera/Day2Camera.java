...
public class Day2Camera {
    private String model;
    private String manufacturer;
    private int megapixel;
    private SdCard sdCard;
    private Objecetiv lens;

    public Day2Camera(String model, String manufacturer, int megapixel) {
        this.model = model;
    ...
    public void setLens(Objecetiv lens) {
        this.lens = lens;
    }

    public void mountLens(Objecetiv lens) {
        if (this.lens == null) {
