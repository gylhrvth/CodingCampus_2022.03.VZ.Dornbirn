...
public class Main {
    public static void main(String[] args) {
        ...
        int intakeOp = rand.nextInt(58) + 34;
        ...
        Animal[] animals = {new Animal("James May", "Snake", meat, intake2, stats1),
                ...
                new Animal("Jeremy Clarkson", "Shark", fishFood, intake2, stats4)};

        CareTaker[] careTakers = {new CareTaker("Jeff"),
                new CareTaker("Jefferson")};

        Vet vet1 = new Vet("Henry Avery");
        ...
        enclosure[0].addVeterinarian(vet1);
        enclosure[2].addVeterinarian(vet1);
