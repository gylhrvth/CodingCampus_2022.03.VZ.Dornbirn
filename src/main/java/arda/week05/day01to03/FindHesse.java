...
public class FindHesse {
    public static void main(String[] args) {
        ...
        String textToAnalyse = "Zur Zeit des Zweiten Weltkriegs waren seine großen Werke Siddhartha und Der Steppenwolf noch verboten. Heute gehört Hermann Hesse zu den bekanntesten deutschen Schriftstellern. Mehr über den Weltveränderer lest ihr hier\n" +
                ...
                "Hermann Hesse\n";
        findHesse(textToAnalyse,RED,RESET);
    }

    public static void findHesse(String text,String red,String reset) {
        int counter = 0;
        int index = text.indexOf("Hesse");
        while (index >= 0){
            System.out.print(index + " ");
            counter++;
            index = text.indexOf("Hesse", 1 + index);
        }
        System.out.println("\n" + "Hesse has been found " + red + counter + reset +" times at the indices given up top.");
    }
}
