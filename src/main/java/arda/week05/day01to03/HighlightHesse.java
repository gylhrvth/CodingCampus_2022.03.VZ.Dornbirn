...
public class HighlightHesse {
    public static void main(String[] args) {
        ...
        String textToAnalyse = "Zur Zeit des Zweiten Weltkriegs waren seine großen Werke Siddhartha und Der Steppenwolf noch verboten. Heute gehört Hermann Hesse zu den bekanntesten deutschen Schriftstellern. Mehr über den Weltveränderer lest ihr hier\n" +
                ...
                "Hermann Hesse\n";
        //highlightHesse(textToAnalyse,RED_BRIGHT, RESET);
        replaceWithInput(textToAnalyse,RED_BRIGHT, RESET,sc);

    }

    public static void highlightHesse(String text, String redBR, String reset) {
        System.out.println(text.replaceAll("Hesse", redBR + "Hesse" + reset));
    }
    public static void replaceWithInput(String text, String redBR, String reset,Scanner sc){
        System.out.println("what would you like to highlight? please enter now.");
        String input = sc.nextLine();
        System.out.println(text.replaceAll(input,redBR + input + reset));
    }
}
